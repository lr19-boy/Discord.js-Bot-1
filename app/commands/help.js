...
exports.run = (client, message, args, config) => {
  ...
  .addFields(
    { name: "Help", value: "Show All Of The Commands Of The Bot" },
    { name: "Ascii", value: "Converts to ascii word"},
    { name: "Bal", value: "Checks your balance money"},
    { name: "Buy", value: "You can buy a car or a laptop or a watch"},
    ...
    { name: "Daily", value: "Daily you will get a random money!"},
    { name: "Meme", value: "Send you a random fun meme to you!"},
    { name: "Weather", value: "It tells you the weather condition of your place! For example: pweather India"},
    { name: "Work", value: "If you work, you will earn more money. :smile:"},
    { name: "Ping", value: "Just type pping"},
    { name: "Say", value: "What you said it reply that word"},
    { name: "Invite", value: "The bot will send you the invite link!"},
